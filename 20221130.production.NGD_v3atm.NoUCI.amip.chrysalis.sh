...
readonly CASE_NAME="20221205.production.NGD_v3atm.v2_test.amip.chrysalis"

# Code and compilation
readonly CHECKOUT="v3atm"
readonly BRANCH="keziming/atm/v3atm_v2" #33d1e46f0cb9a07605171dbad3a5cca6264871a5
readonly CHERRY=( )
...
# Set paths
readonly CODE_ROOT="${HOME}/E3SM_models/12052022_v3atm/${CHECKOUT}"
...
case_setup() {
   ...
   # local usr_mech_infile="/home/ac.zke/E3SM_models/1112-NGD-v3atm/v3atm/components/eam/chem_proc/inputs/pp_chemUCI_linozv3_mam4_resus_mom_soag_tag.in"
    echo 'MW Changing chemistry to :'${usr_mech_infile} 
    #./xmlchange --id CAM_CONFIG_OPTS --append --val='-chem superfast_mam5_resus_mom_vbs_mosaic -mosaic -vbs -usr_mech_infile '${usr_mech_infile}
    #./xmlchange --id CAM_CONFIG_OPTS --append --val='-bc_dep_to_snow_updates -cosp -chem  linoz_mam4_resus_mom_soag -rain_evap_to_coarse_aero -nlev 72 -usr_mech_infile '${usr_mech_infile}
