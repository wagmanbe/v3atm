   ...
   if (use_dem_nucleate) then      ! DeMott, use particles number with D>0.5 um
      ...
      if(clim_modal_aero) then
         ...
         elseif(cam_chempkg_is('trop_mam3') .or. cam_chempkg_is('trop_mam4') .or. &
              ...
              cam_chempkg_is('superfast_mam4_resus_mom_soag') .or. & !QZR ++
              cam_chempkg_is('linoz_mam4_resus_soa_mom_soag') .or. &
              cam_chempkg_is('linoz_mam4_resus_soa_mom_soag_vbs')) then !ASK Hailong about trop_mam4 
