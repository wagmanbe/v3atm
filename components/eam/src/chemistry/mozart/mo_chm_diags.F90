    ...
    do m = 1,gas_pcnst
       ...
       if ((m /= id_cly) .and. (m /= id_bry)) then
          ...
          if ( .not. any( aer_species == m ) ) then
             if (history_gaschmbudget) then
                call add_default( trim(spc_name)//'_MSB', 15, ' ' )
                call add_default( trim(spc_name)//'_MSL', 15, ' ' )
                call add_default( trim(spc_name)//'_MSS', 15, ' ' )
                call add_default( trim(spc_name)//'_MSD', 15, ' ' )
             ...
             if (history_gaschmbudget_2D) then
                call add_default( trim(spc_name)//'_2DMSB', 15, ' ' )
                call add_default( trim(spc_name)//'_2DMSL', 15, ' ' )
                call add_default( trim(spc_name)//'_2DMSS', 15, ' ' )
                call add_default( trim(spc_name)//'_2DMSD', 15, ' ' )
                call add_default( trim(spc_name)//'_2DMSI', 15, ' ' )
                call add_default( trim(spc_name)//'_2DMSE', 15, ' ' )
                call add_default( trim(spc_name)//'_2DMSA', 15, ' ' )
                call add_default( trim(spc_name)//'_2DMSN', 15, ' ' )
                call add_default( trim(spc_name)//'_2DMSU', 15, ' ' )
                call add_default( trim(spc_name)//'_2DMSC', 15, ' ' )
                call add_default( trim(spc_name)//'_2DMSW', 15, ' ' )
             ...
             if (history_gaschmbudget_2D_levels) then
                call add_default( trim(spc_name)//'_2DMSB_L1', 15, ' ' )
                call add_default( trim(spc_name)//'_2DMSL_L1', 15, ' ' )
                call add_default( trim(spc_name)//'_2DMSS_L1', 15, ' ' )
                call add_default( trim(spc_name)//'_2DMSD_L1', 15, ' ' )
                ...
                call add_default( trim(spc_name)//'_2DMSB_L2', 15, ' ' )
                call add_default( trim(spc_name)//'_2DMSL_L2', 15, ' ' )
                call add_default( trim(spc_name)//'_2DMSS_L2', 15, ' ' )
                call add_default( trim(spc_name)//'_2DMSD_L2', 15, ' ' )
                ...
                call add_default( trim(spc_name)//'_2DMSB_L3', 15, ' ' )
                call add_default( trim(spc_name)//'_2DMSL_L3', 15, ' ' )
                call add_default( trim(spc_name)//'_2DMSS_L3', 15, ' ' )
                call add_default( trim(spc_name)//'_2DMSD_L3', 15, ' ' )
                ...
                call add_default( trim(spc_name)//'_2DMSB_L4', 15, ' ' )
                call add_default( trim(spc_name)//'_2DMSL_L4', 15, ' ' )
                call add_default( trim(spc_name)//'_2DMSS_L4', 15, ' ' )
                call add_default( trim(spc_name)//'_2DMSD_L4', 15, ' ' )
             ...
             if (trim(spc_name) == 'O3' .or. trim(spc_name) == 'O3LNZ' .or. &
                ...
                call add_default( trim(spc_name)//'_2DMSB_trop', 15, ' ' )
                call add_default( trim(spc_name)//'_2DMSL_trop', 15, ' ' )
                call add_default( trim(spc_name)//'_2DMSS_trop', 15, ' ' )
                call add_default( trim(spc_name)//'_2DMSD_trop', 15, ' ' )
